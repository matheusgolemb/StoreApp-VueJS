...
export default {
  ...
  methods: {
    ...
    // doLogin(UserData) {
    // after
    // you dont need to set param
    doLogin() {
      // this.loginValid = false;
      // just set username and password to login easily. u can delete after u finish coding
      ...
      this.usersData.forEach((user) => {
        if (this.uName == user.userName && this.uPass == user.password) {
          ...
          // after
          // you need to emit the user info which is suceeded login. And you need to return the info which you successed login
